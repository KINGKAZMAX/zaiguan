...
const KB = [
  { name: "千里江山图", artist: "王希孟", era: "北宋", medium: "绢本设色", category: "绘画", collection: "故宫博物院", hue: "shanqing", style: "paint", ar: 2.9, desc: "青绿山水长卷,群峰竞秀,江河浩渺,十八岁天才的传世孤本。" },
  { name: "清明上河图", artist: "张择端", era: "北宋", medium: "绢本设色", category: "绘画", collection: "故宫博物院", hue: "dailan", style: "paint", ar: 3.2, desc: "汴京市井长卷,八百余人栩栩如生,一座城市的正午记忆。" },
  { name: "步辇图", artist: "阎立本", era: "唐代", medium: "绢本设色", category: "绘画", collection: "故宫博物院", hue: "shanqing", style: "paint", ar: 1.4, desc: "唐太宗接见吐蕃使臣,汉藏友好的历史现场。" },
  { name: "溪山行旅图", artist: "范宽", era: "北宋", medium: "绢本水墨", category: "绘画", collection: "台北故宫博物院", hue: "xuanmo", style: "paint", ar: 0.8, desc: "巨峰壁立,飞瀑千尺,山脚旅人渺小如豆,北宋山水的纪念碑。" },
  { name: "富春山居图", artist: "黄公望", era: "元代", medium: "纸本水墨", category: "绘画", collection: "浙江省博物馆", hue: "xuanmo", style: "paint", ar: 2.8, desc: "七年画就一段富春江,笔意萧散,是文人画的至高山水。" },
  { name: "洛神赋图", artist: "顾恺之(宋摹)", era: "东晋", medium: "绢本设色", category: "绘画", collection: "故宫博物院", hue: "dailan", style: "paint", ar: 2.4, desc: "人神殊途的怅惘爱情,以春蚕吐丝般的线条随画卷徐徐展开。" },
  { name: "韩熙载夜宴图", artist: "顾闳中", era: "五代", medium: "绢本设色", category: "绘画", collection: "故宫博物院", hue: "dailan", style: "paint", ar: 2.6, desc: "听乐、观舞、歇息、清吹、散宴五段连环,一场被「观看」的夜宴。" },
  { name: "瑞鹤图", artist: "赵佶", era: "北宋", medium: "绢本设色", category: "绘画", collection: "辽宁省博物馆", hue: "tianqing", style: "crane", ar: 1.25, desc: "汴梁宣德门群鹤盘旋,青天如洗,宋徽宗的祥瑞时刻。" },
  { name: "快雪时晴帖", artist: "王羲之", era: "东晋", medium: "纸本行书", category: "书法", collection: "台北故宫博物院", hue: "xuanmo", style: "calligraphy", ar: 0.62, desc: "二十八字短札:「羲之顿首。快雪时晴,佳想安善。」" },
  { name: "祭侄文稿", artist: "颜真卿", era: "唐代", medium: "纸本行书", category: "书法", collection: "台北故宫博物院", hue: "yuebai", style: "calligraphy", ar: 0.62, desc: "涂改满纸的悲愤草稿,被称为「天下第二行书」。" },
  { name: "兰亭序(神龙本)", artist: "冯承素(摹)", era: "唐代", medium: "纸本行书", category: "书法", collection: "故宫博物院", hue: "xuanmo", style: "calligraphy", ar: 0.62, desc: "永和九年暮春之初,曲水流觞,二十一个「之」字各不相同。" },
  { name: "莲鹤方壶", artist: "失载工匠", era: "春秋", medium: "青铜", category: "青铜器", collection: "河南博物院", hue: "songlv", style: "bronze", ar: 0.85, desc: "壶顶立鹤展翅,双龙耳侧探,青铜时代的浪漫绝唱。" },
  { name: "大禾人面纹方鼎", artist: "佚名工匠", era: "商代", medium: "青铜", category: "青铜器", collection: "湖南博物院", hue: "zhusha", style: "bronze", ar: 0.9, desc: "四面各一人面,写实与狞厉并存,唯一以人面为饰的商代鼎。" },
  { name: "妇好鸮尊", artist: "佚名工匠", era: "商代", medium: "青铜", category: "青铜器", collection: "中国国家博物馆", hue: "songlv", style: "bronze", ar: 0.85, desc: "战神妇好的猫头鹰,敛翅直立,喙与胸线刚劲如刻。" },
  { name: "青铜大立人像", artist: "佚名工匠", era: "商代晚期", medium: "青铜", category: "青铜器", collection: "三星堆博物馆", hue: "zheshi", style: "bronze", ar: 0.68, desc: "高逾两米,双手环握,古蜀国祭司沉默地站立了三千年。" },
  { name: "铜车马(一号车)", artist: "佚名工匠", era: "秦代", medium: "青铜", category: "青铜器", collection: "秦始皇帝陵博物院", hue: "zhusha", style: "bronze", ar: 1.5, desc: "三千零六十四个零件,「青铜之冠」的立车伞盖下站着御官。" },
  { name: "太阳神鸟金饰", artist: "佚名工匠", era: "商周之际", medium: "金箔", category: "金银器", collection: "成都金沙遗址博物馆", hue: "liujin", style: "gold", ar: 1.05, desc: "厚 0.02 厘米的金箔上,四只神鸟绕日逆时针飞翔,十二道齿芒旋转。" },
  { name: "金面具", artist: "佚名工匠", era: "商代晚期", medium: "金箔", category: "金银器", collection: "三星堆博物馆", hue: "liujin", style: "gold", ar: 0.9, desc: "微笑的黄金面孔,宽耳巨目,古蜀人心中不朽的容颜。" },
  { name: "汝窑天青釉弦纹三足樽", artist: "汝窑", era: "北宋", medium: "瓷器", category: "瓷器", collection: "台北故宫博物院", hue: "tianqing", style: "porcelain", ar: 1.1, desc: "雨过天青云破处,三道弦纹,宋代极简的顶点。" },
  { name: "青花缠枝莲纹瓶", artist: "景德镇窑", era: "明代", medium: "瓷器", category: "瓷器", collection: "故宫博物院", hue: "shanqing", style: "porcelain", ar: 0.75, desc: "苏麻离青发色浓翠,缠枝莲一路缠绕而上,永不凋谢。" },
  { name: "唐三彩骆驼载乐俑", artist: "佚名工匠", era: "唐代", medium: "陶器", category: "瓷器", collection: "中国国家博物馆", hue: "zheshi", style: "terracotta", ar: 0.8, desc: "驼背上一支胡汉混编乐队,黄绿褐三彩流淌,丝路的声音。" },
  { name: "睡莲", artist: "克劳德·莫奈", era: "1906 年", medium: "布面油画", category: "绘画", collection: "芝加哥艺术博物馆", hue: "tianqing", style: "oil", ar: 1.25, desc: "水面、倒影与光,一座池塘画了二十余年,时间本身成为主题。" },
  { name: "向日葵", artist: "文森特·梵高", era: "1888 年", medium: "布面油画", category: "绘画", collection: "伦敦国家美术馆", hue: "liujin", style: "oil", ar: 0.85, desc: "铬黄厚涂的花盘朝着不同方向,在阿尔勒的阳光里燃烧。" },
  { name: "舞蹈课", artist: "埃德加·德加", era: "1874 年", medium: "布面油画", category: "绘画", collection: "奥赛博物馆", hue: "yuebai", style: "oil", ar: 1.25, desc: "排练厅斜角的一瞥,芭蕾舞者整理耳环与缎带,不经意的瞬间。" },
  { name: "星月夜", artist: "文森特·梵高", era: "1889 年", medium: "布面油画", category: "绘画", collection: "纽约现代艺术博物馆", hue: "dailan", style: "oil", ar: 1.25, desc: "圣雷米疗养院窗外的夜空,柏树如黑色火焰,星云旋转。" },
  { name: "思想者", artist: "奥古斯特·罗丹", era: "1880 年", medium: "青铜雕塑", category: "雕塑", collection: "罗丹博物馆", hue: "zhusha", style: "bronze", ar: 0.75, desc: "俯身的沉思者,每块肌肉都在用力思考,为《地狱之门》而生。" },
];
